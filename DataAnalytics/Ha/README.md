...
## Introduction 
This projects is an attempt to visualize the relationships between reported happiness and societal wellness metrics in the context of food afforability, availability, quality, and the resilience of the country's food supply. 
