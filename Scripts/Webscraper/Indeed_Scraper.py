...
def get_url(url,title,location):
    ...
    driver.execute_script('window.alert = function() {}') #---stop popups
...
def get_data(url):
    ...
    for page in range(10, page_list, 10):
...
#-----Export-----
EL_geology_data.to_csv(r'C:\Users\jbean\OneDrive\Desktop\Job Scraper\EL_geology_df1.csv')